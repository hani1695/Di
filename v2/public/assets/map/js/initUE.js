...
var layerWFS1 = new ol.layer.Vector({
	...
	source: new ol.source.Vector({
		...
		loader: function (extent) {
			$.ajax('http://192.168.112.2:8080/geoserver/DIMA/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=DIMA%3Ab_wilaya&maxFeatures=50&outputFormat=text%2Fjavascript', {
				type: 'GET',
