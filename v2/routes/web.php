...
Route::get('typezonevoie/delete/{id}','TypezonevoieController@destroy')->name('typezonevoie.destroy');
Route::resource('typezonevoie', 'TypezonevoieController',[
    'except'=>['destroy']
    ]); 
// Route::post('usage/store2','UsageController@store2')->name('usage.store2');
// Route::view('ajouterfamille', 'type-usagefamille', ['name' => 'famille']);

Route::get('ajouterfamille','UsageController@index2')->name('usage.index2');
...
Route::get('constructionevaluees', 'evaluation\UniteevalueeController@constructionevaluees')->name('constructionevaluees');
Route::get('constructioninaccessible', 'evaluation\UniteevalueeController@constructionevaluees')->name('constructioninaccessible');

Route::get('ficheevaluation/pdf/{id}','evaluation\FicheevaluationController@pdfPrint')->name('ficheevaluation.pdf');
...
// ------evaluations-----
Route::get('declarationDesZones/delete/{id}','utilisateur_et_affectation\AffectationZonesAuxInspecteursController@destroy')->name('declarationDesZones.destroy');
Route::resource('declarationDesZones', 'utilisateur_et_affectation\AffectationZonesAuxInspecteursController',[
    'except'=>['destroy']
]);
...
Route::get('export', 'FicheExportController@export')->name('exportXls');

Route::get('pdf',function(){
    return view('evaluations.liste_des_fiche_devaluations.fiche_en_pdf');
});
Route::get('rapportEval/delete/{id}','reporting\RapportEvalController@destroy')->name('rapportEval.destroy');
Route::resource('rapportEval', 'reporting\RapportEvalController',[
    'except' => ['destroy']
]);
Route::get('RefPub/delete/{id}','reporting\RefPubController@destroy')->name('RefPub.destroy');
Route::resource('RefPub', 'reporting\RefPubController',[
    'except' => ['destroy']
]);


Route::resource('bilanJour', 'BilanJourController');