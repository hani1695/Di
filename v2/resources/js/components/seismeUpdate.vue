...
<div>
  <div class="form-group">
    ...
    <div class=" form-group" ref="pc1" id="pc1" >
      <div class="form-group">
        ...
        <div class=" p-4 bg-white mb-2" style="border: solid 1px #999;" ref="source" v-for="(sourc,index) in sources" :key="sourc.id">
            ...
            <div class="form-group">
                <label for="magnitude" class=" form-control-label">Magnitude </label>
            ...
            <div class="form-group">
                <label for="desc" class=" form-control-label">Localisation </label>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-6">
                    <label for="heure" class=" form-control-label">Heure en (UTC+01:00) </label>
    ...
    <div>
        <div class=" p-4 bg-white mb-2 " style="border: solid 1px #999;"  v-for="(input,k) in inputs" :key="k">
            <div class="form-group">
            <label for="exampleFormControlSelect1">Source d'information N°{{sources.length+k+1}} <span class="text-danger">*</span></label>
                <select class="form-control" id="exampleFormControlSelect1" name="source[]">
                    <option value="" >Selectionner la source d'information</option>
            ...
            <div class="form-row">
                <div class="form-group col-6">
                    <label for="date" class=" form-control-label">Date en UTC </label>
...
export default {
    ...
    mounted : function () {
        this.pcsh1()
        this.getSourceInfos()
        console.log('this = '+this.sources.length)
    }
