            ...
            <div class="card-body card-block">
                ...
                <div class="card-header mb-5">
                    ...
                    <div class="collapse show" id="collapseExample">
                            ...
                            <form action="{{ route('utilisateur.update',$utilisateur_enr->uid) }}" method="post" enctype="multipart/form-data"> @method('PATCH')
                                ...
                                <div id="app6">
                                    <org-dir-stru-edit nomdr="{{ $utilisateur_enr->nom_dr }}" str="{{ $utilisateur_enr->structure }}" org="{{ $utilisateur_enr->organisme }}" nomdrerror="@error('nom_dr'){{ $message }}@enderror" sterror="@error('structure'){{ $message }}@enderror" orgerror="@error('organisme'){{ $message }}@enderror" /></div>
                                <div class="form-group">
