...
<form method="POST" action="{{route('tache.update',$tache_enr->tache)}}" >
   @csrf
   @method('PUT')
   ...
   <div class="form-group">
        ...
        <input type="text"  name="tache" value="{{$tache_enr->tache}}" id="tache" class="form-control {{$errors->has('tache')? 'is-invalid' :''}}" placeholder="tache" aria-label="tache" aria-describedby="basic-addon1" >
            @error('tache')
