                            ...
                            <div class="card card-body">
                                ...
                                <form action="{{ route('tbase.ajouter_direction') }}" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" id="nom" placeholder="Direction" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ old('nom') }}"autofocus>
                                        @error('nom')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('Nom_Org') is-invalid @enderror" id="exampleFormControlSelect1" name="Nom_Org"  >
                                            @if ( old('Nom_Org') )
                                            <option value="{{ old('Nom_Org') }}" selected >{{ old('Nom_Org') }}</option>
                                            @else
