...
@section('ol-menu')
    <ol class="breadcrumb text-right">
        <li><a href="{{ route('tbase.direction')}}">directions</a></li>
...
<div class="row" style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card">
            <div class="card-header"><strong>Liste des Directions</strong><small></small></div>
            ...
            <div class="card-header">
                ...
                <form action="{{ route('tbase.modifier_direction',$direction_enr->id)}}" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group ">
                        <label for="nom" class=" form-control-label">Direction<span class="text-danger">*</span></label>
                        <input type="text" id="nom" placeholder="Direction" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ $direction_enr->nom }}""autofocus>
                        @error('nom')
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Organisme<span class="text-danger">*</span></label>
                        <select class="form-control @error('Nom_Org') is-invalid @enderror" id="exampleFormControlSelect1" name="Nom_Org"  >
                            <option value="{{ $direction_enr->Nom_Org }}" selected >{{ $direction_enr->Nom_Org }}</option>
                    ...
                    <livewire:wilaya-commune :wilaya="$direction_enr->fk_wilaya " :commune=" $direction_enr->fk_commune "> 
                    @csrf
                    <div>
