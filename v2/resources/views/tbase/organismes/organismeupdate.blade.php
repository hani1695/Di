...
@section('ol-menu')
    <ol class="breadcrumb text-right">
        <li><a href="{{ route('tbase.organisme')}}">organismes</a></li>
            ...
            <div class="card-header">
                ...
                <form action="{{ route('tbase.modifier_organisme',$organisme_enr->id)}}" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" id="nom" placeholder="Désignation" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ $organisme_enr->nom }}""autofocus>
                        @error('nom')
                    ...
                    <livewire:wilaya-commune :wilaya="$organisme_enr->fk_wilaya " :commune=" $organisme_enr->fk_commune "> 
