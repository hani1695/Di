...
@section('ol-menu')
    <ol class="breadcrumb text-right">
        <li><a href="#">Type d'adresse</a></li>
        <li class="active">Liste des types d'adresses</li>
    </ol>
@endsection
...
<div class="row" style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card">
            <div class="card-header"><strong>Liste des types d'adresses</strong><small> </small></div>
