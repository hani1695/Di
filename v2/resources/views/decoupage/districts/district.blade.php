...
<div class="row" style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card">
            <div class="card-header"><strong>Liste des Districts</strong><small> </small></div>
                  ...
                  <div class="card card-body">
                        <form action="{{ route('district.store') }}" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                <label for="id_district" class=" form-control-label">Code <span class="text-danger">*</span></label>
                            ...
                            {{-- <div class="form-row"> --}}
                                <div class="form-group ">
                                    <label for="num_district" class=" form-control-label">  District<span class="text-danger">*</span></label>
