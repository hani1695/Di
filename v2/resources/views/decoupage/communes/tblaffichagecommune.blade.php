    ...
    <tbody>
        ...
        @foreach ($commune as $communes)
            <tr class="{{ (Session::has('success') && $loop->index==0) ? 'table-success' : '' }}"> 
                ...
                <td class="tdlibelle">  {{ $communes->nom_w  }}   </td>
                ...
                <td>
                <a href="{{route('commune.detaille',$communes->code_c)}}" class="btn btn-sm btn-info " title="detail" data-toggle="tooltip" data-placement="bottom"><i class="far fa-eye"></i></a>
