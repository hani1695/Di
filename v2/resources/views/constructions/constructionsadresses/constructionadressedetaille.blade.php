...
<div class="form-row">
   ...
   <div class="form-group  col-6">
        <div class=" form-control-label">
            <span class=" form-control-label" id="basic-addon1">Désignation</span>
        </div>
...
<div class="form-row">
   ...
   <div class="form-group  col-6">
        <div class=" form-control-label">
            <span class=" form-control-label" id="basic-addon1">nature zone</span>
        </div>
        <input type="text"  name="nature_zonep" value="{{$constructionadresse_enr->descreption_t_adr}}" id="nature_zonep" readonly class="form-control {{$errors->has('nature_zonep')? 'is-invalid' :''}}"  aria-label="nature_zonep" aria-describedby="basic-addon1">
            @error('nature_zonep')
            <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span>
            @enderror    
    </div>
...
<div class="form-row">
   ...
   <div class="form-group  col-6">
        <div class=" form-control-label">
            <span class=" form-control-label" id="basic-addon1">Adresse arabe</span>
        </div>
...
<div class="form-row">
   ...
   <div class="form-group  col-6">
        <div class=" form-control-label">
            <span class=" form-control-label" id="basic-addon1">état</span>
        </div>
