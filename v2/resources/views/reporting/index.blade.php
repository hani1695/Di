...
@section('ol-menu')
    <ol class="breadcrumb text-right">
        ...
        <li class="active">Rapport d'évaluation</li>
    </ol>
@endsection
@section('content')
@if (Session::has("event_id"))
    ...
    <div class="row" style="margin-bottom: 100px;">
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header"><strong>Créer un rapport d'évaluation</strong><small> Formulaire</small></div>
                ...
                <a class="btn btn-info mb-2" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="{{ Session::has('errors') ? true : false}}" aria-controls="collapseExample">
                    Ajouter un rapport d'évaluation
                </a>
                <div class="collapse {{ Session::has('errors') ? 'show' : ''}}" id="collapseExample">
                <div class="card-body card-block">
                    <form method="POST" action="{{ route('rapportEval.store') }}" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="description" class=" form-control-label">Intitulé du rapport <span
                                    class="text-danger">*</span></label>
                            <input type="text" id="description" value="{{ old('description') }}" placeholder="Intitulé du rapport" class="form-control @error('description') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            <label for="date_creation" class=" form-control-label">Date du rapport <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlFile1">Pièce jointe du rapport </label> <span
                            class="text-danger">*</span>
                            <input type="file" class="form-control-file @error('lien_rapp') is-invalid @enderror" value="{{ old('lien_rapp') }}" id="exampleFormControlFile1" name="lien_rapp">
                            @error('lien_rapp')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>                                
