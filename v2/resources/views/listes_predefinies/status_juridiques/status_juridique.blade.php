...
@section('ol-menu')
    <ol class="breadcrumb text-right">
        ...
        <li class="active">Status juridiques</li>
    </ol>
@endsection
...
<div class="row " style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card" >
            <div class="card-header"><strong>Status juridiques</strong><small></small></div>
                  ...
                  <div class="card card-body">
                        <form action="{{ route('status_juridique.store') }}" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                <label for="id_statu_j" class=" form-control-label">Code  <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group ">
                                    <label for="descreption_s" class=" form-control-label">Designation<span class="text-danger">*</span></label>
