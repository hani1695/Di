...
@section('ol-menu')
    <ol class="breadcrumb text-right">
        ...
        <li class="active">Mesures immediates</li>
    </ol>
@endsection
...
<div class="row " style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card" >
            <div class="card-header"><strong>Mesures immediates</strong><small></small></div>
                  ...
                  <div class="card card-body">
                        <form action="{{ route('mesure.store') }}" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                ...
                                <div class="form-group ">
                                    <label for="descreption_mesure" class=" form-control-label">Designation<span class="text-danger">*</span></label>
