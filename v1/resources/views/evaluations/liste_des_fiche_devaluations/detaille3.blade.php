                    ...
                    <tbody>
                        {{-- @foreach ($ficheevaluations as $ficheevaluation) --}}
                            <tr> 
                              ...
                              <tr> 
                                <td style="text-align:center">Nombre de joints de dilatation -en elevation:</td><td style="text-align:center">{{ $ficheevaluation->nb_join_in  }}</td>
                              </tr> 
                              <tr> 
                                <td style="text-align:center">Nombre de joints de dilatation - Infrastructure</td><td style="text-align:center">{{ $ficheevaluation->nb_join_el  }}</td>
                              </tr> 
                              <tr> 
