                ...
                <div class="card-body card-block">
                    ...
                    <form method="POST" action="{{ route('constructionAevaluer.store') }}">
                        ...
                        <div class="form-group">
                            <label for="wilaya">Zone <span class="text-danger">*</span></label>
                            <select class="form-control" id="zone_id" name="zone_id" required>
                                <option selected disabled>Selectionner la zone voulue </option>
                                @foreach ($zones as $zone)
                                    <option value="{{ $zone->id_zone }}" >{{ $zone->nom_zone }} ({{ $zone->num_zone }})</option>
                                @endforeach
                            </select>
                        </div>
