...
<div class="row breadcrumb" style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card" >
            <div class="card-header"><strong>Liste des structures</strong><small> filtre</small></div>
                        ...
                        <form action="{{ route('tbase.ajouter_structure') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                    <div class="form-group col-6">
                                       ...
                                       <input type="text" id="code_ag" placeholder="code_ag" class="form-control @error('code_ag') is-invalid @enderror" name="code_ag" value="{{ old('code_ag') }}"autofocus>
                                       @error('code_ag')
