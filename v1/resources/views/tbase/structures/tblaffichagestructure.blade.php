    ...
    <tbody>
        ...
        @foreach ($structures as $structure)
            <tr class="{{ (Session::has('success') && $loop->index==0) ? 'table-success' : '' }}"> 
                ...
                <td>
                    <a href="{{route('tbase.detaille_structure',$structure->id)}}" class="btn btn-sm btn-warning " title="detaille" data-toggle="tooltip" data-placement="bottom"><i class="far fa-edit"></i></a>
