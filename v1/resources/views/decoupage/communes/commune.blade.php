...
@section('ol-menu')
    <ol class="breadcrumb text-right">
        ...
        <li class="active">Liste commune</li>
    </ol>
@endsection
...
<div class="row breadcrumb" style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card" >
            <div class="card-header"><strong>Liste des communes</strong><small> table</small></div>
                        ...
                        <form action="{{ route('commune.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                    <div class="form-group col-6">
                                       <label for="code_c" class=" form-control-label">code commune<span class="text-danger">*</span></label>
                                       <input type="text" id="code_c" placeholder="code" class="form-control @error('code_c') is-invalid @enderror" name="code_c" value="{{ old('code_c') }}"autofocus>
                                       @error('code_c')
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-6">
                                            <label for="nom_c" class=" form-control-label"> nom commune<span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group col-6">
                                                <label for="nom_c_arb" class=" form-control-label"> nom commune arabe<span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-6">
                                    <label for="autre_nom_c" class=" form-control-label">autre_nom_c <span class="text-danger">*</span></label>
