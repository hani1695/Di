        ...
        <tbody>
            ...
            @foreach ($routier as $routiers)
                <tr class="{{ (Session::has('success') && $loop->index==0) ? 'table-success' : '' }}"> 
                    ...
                    <td>
                        <a href="{{route('routier.detaille',$routiers->id_tr)}}" class="btn btn-sm btn-warning " title="detaille" data-toggle="tooltip" data-placement="bottom"><i class="far fa-edit"></i></a>
