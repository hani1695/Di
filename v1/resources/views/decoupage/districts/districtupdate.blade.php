...
<div class="row" style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card">
            <div class="card-header"><strong>Liste des districts - Modification</strong><small> Formulaire</small></div>
            <div class="card-body card-block">
                 

<form method="POST" action="{{route('district.update',$district_enr->id_district)}}" class="container">
   @csrf
   @method('PUT')
   ...
   <div class="form-group ">
    ...
    <div class="form-group ">
        <div class=" form-control-label">
            <span class=" form-control-label" id="basic-addon1">numero district</span>
        </div>
