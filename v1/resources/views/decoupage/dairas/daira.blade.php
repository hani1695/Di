...
@section('ol-menu')
    <ol class="breadcrumb text-right">
        <li><a href="#">Dairas</a></li>
        <li class="active">Liste Daira</li>
    </ol>
@endsection
...
<div class="row breadcrumb" style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card" >
            <div class="card-header"><strong>Liste des Dairas</strong><small> filtre</small></div>
                  ...
                  <div class="card card-body">
                        <form action="{{ route('daira.store') }}" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                ...
                                <input type="text" id="code_d" placeholder="code" class="form-control @error('code_d') is-invalid @enderror" name="code_d" value="{{ old('code_d') }}"autofocus>
                                @error('code_d')
                            ...
                            {{-- <div class="form-row"> --}}
                                <div class="form-group ">
                                    <label for="nom_d" class=" form-control-label"> nom daira<span class="text-danger">*</span></label>
                                    <input type="text" id="nom_d" placeholder="nom" class="form-control @error('nom_d') is-invalid @enderror" name="nom_d" value="{{ old('nom_d') }}">
                                    @error('nom_d')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>                                
                                ...
                                <div class="form-group ">
                                    <label for="siege_d" class=" form-control-label">siege <span class="text-danger">*</span></label>
                                    <input type="siege_d" id="siege_d" placeholder="siege" class="form-control @error('siege_d') is-invalid @enderror" value="{{ old('siege_d') }}"name="siege_d" >
                                    @error('siege_d')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                            </span>                                
                            ...
                            {{-- </div> --}}
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" id="autre_nom_d" placeholder="autre nom" class="form-control @error('autre_nom_d') is-invalid @enderror" value="{{ old('autre_nom_d') }}"name="autre_nom_d" >
                                    @error('autre_nom_d')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>                                
                                ...
                                <div class="form-group ">
                                    <label for="source_donnees" class=" form-control-label"> source dse donnees<span class="text-danger">*</span></label>
                                    <input type="text" id="source_donnees" placeholder="source des donnees" class="form-control @error('source_donnees') is-invalid @enderror" value="{{ old('source_donnees') }}"name="source_donnees">
