...
<div class="row breadcrumb" style="margin-bottom: 100px;">
    ...
    <div class="col-lg">
        <div class="card" >
            <div class="card-header"><strong>Liste des Ilots</strong><small> table</small></div>
                ...
                <a class="btn btn-info mb-2" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="{{ Session::has('errors') ? true : false}}" aria-controls="collapseExample">
                  ...
                  <div class="card card-body">
                        <form action="{{ route('ilot.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            {{-- <div class="form-row"> --}}
                                <div class="form-group ">
                                    <label for="nom_ilot" class=" form-control-label"> nom ilot<span class="text-danger">*</span></label>
                            ...
                            {{-- </div> --}}
                            <div class="form-group">
                                <label for="nom_arb" class=" form-control-label">nom arabe<span class="text-danger">*</span></label>
