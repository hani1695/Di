  ...
  /**
    ...
    //     }
        ...
        public function detaille($id){
         ...
         $commune_enr=  DB::table('b_commune')->join('b_wilaya', 'b_wilaya.code_w', '=', 'b_commune.fk_wilaya')
         ->join('b_daira', 'b_daira.code_d', '=', 'b_commune.fk_diara')->where('code_c',$id)
         ->first();
          $wilayas = DB::table('b_wilaya')->get();
        ...
        public function update(Request $request,$id){
          ...
          $this->validate($request,[
                  ...
                  //  'geom_com' =>'required',
                   'zone_sis' =>'required',
                   'distance_chef' =>'required|numeric',                 
                   'population' =>'required|numeric',
                   'surface' =>'required|numeric',
                   'zone_vent' =>'required|numeric',
                   'zone_niege' =>'required|numeric',                 
                   'fk_wilaya' =>'required',
                   'fk_diara' =>'required',
                   ]);            
