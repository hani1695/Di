  ...
  /**
    ...
    public function recherche($p){
     ...
     public function index() {
        ...
        if ( $privilege->consultation) return view('constructions.constructions.construction',compact('usages','construction','privilege','constructions')) ;
        else
        ...
        public function edit($id){
         ...
         $construction_enr= construction::where('id_const',$id)
          ...
          return view('constructions.constructions.constructionupdate',compact('usages','construction','construction_enr','privilege'
          ,'wilayas','dairas','communes','districts','ilots')) ;
        }
